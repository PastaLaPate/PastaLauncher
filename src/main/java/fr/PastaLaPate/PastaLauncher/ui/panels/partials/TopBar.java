package fr.PastaLaPate.PastaLauncher.ui.panels.partials;
...
public class TopBar extends Panel {
    ...
    public void init(PanelManager panelManager) {
        ...
        // TopBar: center
        Label title = new Label("PASTA LAUNCHER");
        ...
        FontAwesomeIconView fullscreenBtn = new FontAwesomeIconView(FontAwesomeIcon.WINDOW_RESTORE);
        ...
        fullscreenBtn.setFill(Color.GREEN);
        fullscreenBtn.setTranslateY(3d);
        ...
        minimizeBtn.setFill(Color.ORANGE);
        minimizeBtn.setTranslateY(-1d);
